...
Если вы находите это запутанным, не позволяйте этому Big-O сильно беспокоить вас. В основном это полезно при сравнении двух алгоритмов, чтобы выяснить, какой из них лучше. Но в итоге все же хочется проверить на практике, какой из них действительно лучший. А если объем данных относительно небольшой, то даже медленный алгоритм будет достаточно быстрым для практического использования.
